        ...
        {isSidebarOpen && (
          <>
            ...
            <button
              ...
              className="flex items-center lg:mt-[70px] mb-[200px] justify-center w-full bg-white text-indigo-600 hover:bg-gray-100 p-2 rounded focus:outline-none transition"
            >
